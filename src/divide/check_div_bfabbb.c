...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/25 11:51:34 by mayocorn          #+#    #+#             */
/*   Updated: 2022/06/25 11:54:16 by mayocorn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_div_bfabbb(t_div_info *div_info, size_t *max_cnt, int min_element)
{
	size_t	cnt;
	size_t	size;
	int		large;
