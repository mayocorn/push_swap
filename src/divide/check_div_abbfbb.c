...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/25 11:35:06 by mayocorn          #+#    #+#             */
/*   Updated: 2022/06/25 17:00:22 by mayocorn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_div_abbfbb(t_div_info *div_info, size_t *max_cnt, int min_element)
{
	size_t	cnt;
	size_t	size;
	int		large;
