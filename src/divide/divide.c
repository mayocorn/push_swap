...
/*   Updated: 2022/07/08 00:39:24 by mayocorn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	divide(t_div_info *div_info)
{
	...
	while (elements->size)
	{
		...
		if (number <= (div_info->small))
			div_info->s_push(div_info, div_info->s_q, div_info->s_command);
		else if (number >= (div_info->large))
			div_info->l_push(div_info, div_info->l_q, div_info->l_command);
		else
			div_info->m_push(div_info, div_info->m_q, div_info->m_command);
	}
